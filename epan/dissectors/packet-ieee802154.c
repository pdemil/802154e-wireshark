/* packet-ieee802154.c
 *
 * $Id: packet-ieee802154.c 48404 2013-03-18 22:16:58Z etxrab $
 *
...
static gboolean ieee802154_cc24xx = TRUE;

/* boolean value set if the FCS must be ok before payload is dissected */
static gboolean ieee802154_fcs_ok = FALSE;
...
dissect_ieee802154_fcs:
    ...
    if (!fcs_ok) {
        ...
        expert_add_info_format(pinfo, proto_root, PI_CHECKSUM, PI_WARN, "FCS !OK");
    }
    pinfo->private_data = pd_save;
} /* dissect_ieee802154_common */
...
void proto_register_ieee802154(void)
{
    ...
    /* add radioperf as a subdissector? */
